...
I'm a **QA Automation Engineer** passionate about building reliable, scalable test infrastructure that catches bugs before they reach production. I specialize in AI-powered testing tools, end-to-end automation frameworks, and bridging the gap between engineering and customer success.

- 🤖 Building intelligent test suites with **Momentic** and **Playwright**
- 🔍 Passionate about **shift-left testing** and quality-first development
- ☁️ Exploring **cloud-based test orchestration** and CI/CD quality gates
- 🛠️ Customer Success Engineer by day — automating everything by night
...
End-to-end test automation using Playwright — covering cross-browser testing, API validation, and CI/CD integration with GitHub Actions.

### 🤖 Momentic AI Testing
Leveraging Momentic's AI-powered testing platform to write and maintain resilient UI tests that self-heal and reduce flakiness.

### 🗺️ Central Park Explorer *(Swift)*
A mobile app helping users discover hidden gems in Central Park with geolocation, real-time navigation, and historical facts.

---

## 🌱 What I'm Focused On

- 📐 Designing **test strategies** that scale with fast-moving products
- 🧠 Exploring **AI-assisted QA** workflows with Momentic
- 🔗 Integrating quality gates into **CI/CD pipelines**
- 📱 Building iOS mini-games with **Swift** on the side

---

## 🤝 Let's Connect

Open to conversations about QA automation, AI-powered testing, DevOps, or anything in between.

**LinkedIn:** [Yale Tucker Norman](https://www.linkedin.com/in/yale-tucker-norman-28a263b6/)
